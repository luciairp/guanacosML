...
Para eso necesito información de transectas y muestreos de donde copiar y hacer los joins:
...
guess_encoding("info_areas.csv")
areas <- read_csv("info_areas.csv", locale = locale(encoding = "ASCII"),
                  col_types = cols(
